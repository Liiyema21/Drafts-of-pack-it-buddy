...
<section class="text-gray-600 body-font">
  ...
  <div class="container px-5 py-24 mx-auto flex">
    ...
    <h2 class="text-gray-900 text-3xl mb-1 font-medium title-font">Referals & Reviews</h2>
      ...
      <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-[#131a4b] rounded-lg text-white font-bold text-lg'>Send Review</button>
    </div>
  </div>
</section>
...
export default RefferalsandReviews