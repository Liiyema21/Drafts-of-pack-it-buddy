...
const LogInForm = () => {
  ...
  <div className='w-10/12 px-20 py-20 max-w-screen-lg mx-auto flex 
      flex-col items-center justify-center h-full md:flex-row
  rounded-2xl bg-gray-50 border-2 border-gray-100'>
        
        <h1 className='mt-2 text-5xl font-semibold text-[#131a4b]'>Welcome Back</h1>
        <div className='mt-8 px-8'>
            ...
            <div className='mt-8 flex justify-between items-center'>
                ...
                <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] px-8 font-medium text-base text-amber-500'>Forgot password</button>
            </div>
            <div className='mt-8 flex flex-col gap-y-4'>
                <Link
                      to='/ClientLandingPage'
        ...
        <p className="font-medium text-base text-"> Don't have an accont </p>
